...
public class OasObjectDiffValidatorTemplate<T> implements OasObjectDiffValidator<T> {
    ...
    @Override
    public List<OasDiffViolation> validate(OasDiffValidationContext context, OasObjectPropertyLocation leftLocation, T leftOasObject, OasObjectPropertyLocation rightLocation, T rightOasObject) {
     ...
     * @return
     */
    protected List<OasDiffViolation> validateAdd(OasDiffValidationContext context, OasObjectPropertyLocation rightLocation, T rightOasObject) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
     ...
     * @return
     */
    protected List<OasDiffViolation> validateDel(OasDiffValidationContext context, OasObjectPropertyLocation leftLocation, T leftOasObject) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
