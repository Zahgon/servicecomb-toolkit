...
public class SchemaDiffValidatorEngine extends OasObjectDiffValidatorTemplate<Schema> implements SchemaDiffValidator {
    ...
    private List<OasDiffViolation> validateCompareOrdinary(OasDiffValidationContext context, OasObjectPropertyLocation leftLocation, Schema leftOasObject, OasObjectPropertyLocation rightLocation, Schema rightOasObject) {
        return doDiffValidateMapProperty(context, "properties", leftLocation, leftOasObject.getProperties(), rightLocation, rightOasObject.getProperties(), SCHEMA, singletonList(this));
    }
    ...
    private List<OasDiffViolation> validateCompareArray(OasDiffValidationContext context, OasObjectPropertyLocation leftLocation, Schema leftOasObject, OasObjectPropertyLocation rightLocation, Schema rightOasObject) {
        ...
        return doDiffValidateProperty(context, leftItemsLocation, leftItems, rightItemsLocation, rightItems, singletonList(this));
    }
    ...
    private List<OasDiffViolation> validateCompareComposed(OasDiffValidationContext context, OasObjectPropertyLocation leftLocation, Schema leftOasObject, OasObjectPropertyLocation rightLocation, Schema rightOasObject) {
        ...
        violations.addAll(doDiffValidateListProperty(context, "allOf", leftLocation, leftAllOf, rightLocation, rightAllOf, SCHEMA, schema -> System.identityHashCode(schema), singletonList(this)));
        violations.addAll(doDiffValidateListProperty(context, "oneOf", leftLocation, leftOneOf, rightLocation, rightOneOf, SCHEMA, schema -> System.identityHashCode(schema), singletonList(this)));
        violations.addAll(doDiffValidateListProperty(context, "anyOf", leftLocation, leftAnyOf, rightLocation, rightAnyOf, SCHEMA, schema -> System.identityHashCode(schema), singletonList(this)));
        return violations;
    }
}
