...
public class OperationRequestBodyDiffValidator extends ObjectPropertyDiffValidator<Operation, RequestBody> implements OperationDiffValidator {

    public OperationRequestBodyDiffValidator(List<RequestBodyDiffValidator> requestBodyDiffValidators) {
